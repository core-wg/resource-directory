...
registration resources of the endpoints that belong to that group. The endpoints MAY be hosted by a different RD than the the group hosting RD. In that case the endpoint link SHOULD contain an "anchor=" attribute.
